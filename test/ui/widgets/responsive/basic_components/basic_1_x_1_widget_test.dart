import 'package:aleteo_arquetipo/ui/widgets/responsive/basic_components/basic_1_x_1_widget.dart';
...
void main() {
  ...
  group('Basic1x1Widget', () {
    ...
    testWidgets('renders child with correct size', (WidgetTester tester) async {
      ...
      expect(sizedBox.height, equals(expectedWidth));
